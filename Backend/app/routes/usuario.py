...
@router.post("/usuarios/me/reset-password-direct")
def reset_password_direct(
    ...
    """
    Permite restablecer la contraseña directamente (sin correo).
    Espera:
    {
        "nueva_contrasena": "...",
    ...
    return {"mensaje": "Contraseña actualizada correctamente sin correo."}
