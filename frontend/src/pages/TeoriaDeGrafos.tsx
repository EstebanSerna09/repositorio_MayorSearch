...
export default function TeoriaDeGrafos() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed top-6 right-8 z-9999 transition-all duration-500 ease-in-out transform ${showTop ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-6 pointer-events-none"
          }`}
      >
        <UserMenu />
      </div>
          ...
          >
            ...
            <div className="mt-3 mb-6 text-sm text-center" style={{ color: colors.titulo }}>
              ...
              <Link
                ...
                onMouseLeave={(e) => ((e.currentTarget as HTMLAnchorElement).style.color = colors.titulo)}
              >
                Teoría de grafos
              </Link>
              ?
