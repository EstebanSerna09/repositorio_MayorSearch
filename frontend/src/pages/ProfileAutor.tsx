    ...
    borde:
      theme === "dark"
        ...
        : theme === "blue"
          ...
          : "rgba(0,0,0,0.06)",
    cardBg:
      theme === "dark" ? "var(--card-bg)" : "var(--card-bg)",
    inputFocus:
      theme === "dark" ? "#d6a43a" : theme === "blue" ? "#ffd166" : "#8a6b12",
  };
  // ---------------------------
...
>
      ...
      <main
        className={`flex-1 flex flex-col items-center justify-start transition-all duration-500 ${isCollapsed ? "md:pl-20" : "md:pl-64"
          }`}
      >
...
>
            {/* Tarjeta principal */}
            <div className="shadow-lg rounded-2xl p-8 relative hover:scale-[1.02] transition"
              style={{
            ...
            <div className="mt-10 mb-4 flex flex-col sm:flex-row justify-between items-center gap-4">
              <h2 className="text-2xl font-bold" style={{ color: colors.titulo }}>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-9 pr-3 py-2 text-sm border rounded-md shadow-sm focus:outline-none transition w-48"
                    style={{
                      border: `1px solid ${colors.borde}`,
                      color: colors.texto,
                      backgroundColor: colors.cardBg,
